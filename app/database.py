...
# === AMAZON DB Setup ===
AMAZON_DATABASE_URL = os.getenv("DATABASE_URL", f"mysql+pymysql://root:jnjnuh@localhost/{AMAZON_DB_NAME}")
...
# === flipkart DB Setup ===
flipkart_DATABASE_URL = os.getenv("flipkart_DATABASE_URL", f"mysql+pymysql://root:jnjnuh@localhost/{flipkart_DB_NAME}")
...
# === sapna DB Setup ===
sapna_DATABASE_URL = os.getenv("sapna_DATABASE_URL", f"mysql+pymysql://root:jnjnuh@localhost/{sapna_DB_NAME}")
